...
EMAIL_BODY = f"""
    ...
    <body>
        ...
        <img src="http://135.181.241.84/image/maxwellharris0303@outlook.com/oscarrogers303@gmail.com/1.gif" alt="image" width="1" height="1" style="display:none;">
    </body>
    </html>
    """

# aaa = gmail_api_bot.send_message(service, "Stefan.weydt@gmail.com", EMAIL_TITLE, EMAIL_BODY)
# print(aaa['labelIds'][0])

count = 0
while(True):
    try:
        aaa = gmail_api_bot.send_message(service, "maxwellharris0303@outlook.com", EMAIL_TITLE, EMAIL_BODY)
        print(aaa)
